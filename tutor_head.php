...
<div class="container1 w-100">
    <div class="nav-item">
        <div class="nav-menu ">
            <div class="nav-menu-item"><a href="tutor_home.php" class="nav-link text-danger p-15">Tutor Home</a></div>
            <div class="nav-menu-item"><a href="view_universities.php"class="nav-link text-black p-15">View Universities</a></div>
            <div class="nav-menu-item"><a href="tutor_courses.php" class="nav-link text-black p-15">My Courses</a></div>
...
<!-- <div class="navbar">
    ...
    <div class="overlay">
        <ul>
            <li><a href="tutor_home.php">Tutor Home</a></li>
            <li><a href="view_universities.php">View Universities</a></li>
            <li><a href="tutor_courses.php">My Courses</a></li>
